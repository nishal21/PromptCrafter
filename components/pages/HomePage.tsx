...
const HomePage: React.FC<HomePageProps> = ({ apiKey }) => {
    ...
    return (
        <>
            <h1 className="text-4xl md:text-6xl font-bold text-center text-transparent bg-clip-text bg-gradient-to-b from-white to-gray-400">
                PromptCrafter AI
            </h1>
            <p className="mt-4 text-lg md:text-xl text-center text-gray-400 max-w-2xl">
                Turn your raw ideas into powerful, ready-to-use prompts for any AI model.
            </p>

            <div className="w-full max-w-4xl mt-12 bg-gray-900/50 backdrop-blur-sm border border-gray-700/50 rounded-2xl p-6 md:p-8">
                <PromptForm
                    idea={idea}
                    setIdea={setIdea}
                    tool={tool}
